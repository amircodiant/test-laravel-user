                            ...
                            <form action="dashboard.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="password"  name="password" class="form-control noradius input-lg" placeholder="Password" />
                                    </div>                                       
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group mb-10 mt-15 mt-xs-0">
                                    <button type="submit" class="btn btn-primary btn-block noradius btn-lg waves-effect waves-button waves-light font-700">LOGIN</button>                                    
                                </div>
                                <ul class="list-inline text-center mb-0">
                                    <li><a href="forgetpassword.php" class="themelink">Forget Password</a></li>
                                </ul>
                            </form>
                        </div>
                    </section>
